...
title_entry = ttk.Entry(root,width=14,textvariable=title_text)
...
author_entry = ttk.Entry(root,width=14,textvariable=author_text)
...
isbn_text = StringVar()
isbn_entry = ttk.Entry(root,width=14,textvariable=isbn_text)
isbn_entry.grid(row=0, column=5, sticky=W)

add_btn = Button(root, text="Add Book",bg="blue",fg="blue", font="helvetica 10 bold", command="")
